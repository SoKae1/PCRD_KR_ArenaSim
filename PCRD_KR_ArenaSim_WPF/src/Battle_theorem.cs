...
namespace PCRD_KR_ArenaSim
{
    ...
    class Battle_theorem
    {
        ...
        public static void damage_step(string attack_type, double damage, double hit, double crit, int my_order, int opponent_order)
        {
            ...
            {
                //성에루 치에루 스택
                if (Battle_variable.name_eng[my_order] == "chieru_terefes" && ((Character_skill.chieru_terefes_opponent_chieru == true && my_order < 15) || (Character_skill.chieru_terefes_opponent_chieru_est == true && my_order >= 15)))//성에루
                {
                ...
                if (Battle_variable.name_eng[my_order] == "chloe_terefes" && ((Character_skill.chloe_terefes_opponent_counter < 1 && my_order < 15) || (Character_skill.chloe_terefes_opponent_counter_est < 1 == true && my_order >= 15)))//성에루
                {
                    ...
                    {
                        Battle_variable.chloe_terefes_stack[my_order] += 1;
                    }
                }
                //크리티컬 시
