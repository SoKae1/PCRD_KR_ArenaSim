        ...
        */
        ...
        public string IDtoCharaEngName(string ID)
        {
            try
            {
                ...
                else if (LikeOperator.LikeString(ID, "1097*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "rem";
                else if (LikeOperator.LikeString(ID, "1098*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "ram";
                ...
                else if (LikeOperator.LikeString(ID, "1169*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "mihuyu_worker";
                else if (LikeOperator.LikeString(ID, "1170*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "eriko_summer";
                else if (LikeOperator.LikeString(ID, "1171*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "sizuru_summer";
                else if (LikeOperator.LikeString(ID, "1172*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "nozomi_summer";
                else if (LikeOperator.LikeString(ID, "1173*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "chika_summer";
                else if (LikeOperator.LikeString(ID, "1174*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "tsumugi_summer";
                else if (LikeOperator.LikeString(ID, "1175*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "mitsuki_ooedo";
                else if (LikeOperator.LikeString(ID, "1176*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "yuki_ooedo";
                else if (LikeOperator.LikeString(ID, "1177*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "kaori_halloween";
                else if (LikeOperator.LikeString(ID, "1178*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "ninon_halloween";
                else if (LikeOperator.LikeString(ID, "1179*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "suzuna_halloween";
                else if (LikeOperator.LikeString(ID, "1180*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "credita";
                else if (LikeOperator.LikeString(ID, "1181*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "ranpa";
                else if (LikeOperator.LikeString(ID, "1183*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "hatsune_princess";
                else if (LikeOperator.LikeString(ID, "1184*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "siori_princess";
                else if (LikeOperator.LikeString(ID, "1185*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "karin";
                else if (LikeOperator.LikeString(ID, "1190*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "io_noir";
                else if (LikeOperator.LikeString(ID, "1191*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "kuuka_noir";
                else if (LikeOperator.LikeString(ID, "1192*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "mahiru_christmas";
                else if (LikeOperator.LikeString(ID, "1193*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "rino_christmas";
                else if (LikeOperator.LikeString(ID, "1199*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "miyako_christmas";
                else if (LikeOperator.LikeString(ID, "1204*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "mimi_princess";
                else if (LikeOperator.LikeString(ID, "1205*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "misogi_princess";
                else if (LikeOperator.LikeString(ID, "1206*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "kyouka_princess";
                else if (LikeOperator.LikeString(ID, "1207*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "shepi_newyear";
                else if (LikeOperator.LikeString(ID, "1208*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "ruka_newyear";
                else if (LikeOperator.LikeString(ID, "1209*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "iriya_newyear";
                else if (LikeOperator.LikeString(ID, "1210*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "pekorinnu_overload";
                else if (LikeOperator.LikeString(ID, "1211*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "kyaru_overload";
                else if (LikeOperator.LikeString(ID, "1212*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "labirista_overload";
                else if (LikeOperator.LikeString(ID, "1213*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "kurumi_stage";
                ...
                else if (LikeOperator.LikeString(ID, "1807*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "hatsusio";
                else if (LikeOperator.LikeString(ID, "1808*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "littlelyri";
                else return null;
            }
            catch (Exception e)
            {
        ...
        public string IDtoCharaKorName(string ID)
        {
            try
            {
                ...
                else if (LikeOperator.LikeString(ID, "1097*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "렘";
                else if (LikeOperator.LikeString(ID, "1098*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "람";
                ...
                else if (LikeOperator.LikeString(ID, "1163*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "성유니";
                else if (LikeOperator.LikeString(ID, "1165*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "시노리";
                else if (LikeOperator.LikeString(ID, "1166*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "타카야";
                ...
                else if (LikeOperator.LikeString(ID, "1169*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "작후유";
                else if (LikeOperator.LikeString(ID, "1170*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "수리코";
                else if (LikeOperator.LikeString(ID, "1171*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "수즈루";
                else if (LikeOperator.LikeString(ID, "1172*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "수조미";
                else if (LikeOperator.LikeString(ID, "1173*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "수치카";
                else if (LikeOperator.LikeString(ID, "1174*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "수무기";
                else if (LikeOperator.LikeString(ID, "1175*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "오츠키";
                else if (LikeOperator.LikeString(ID, "1176*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "오유키";
                else if (LikeOperator.LikeString(ID, "1177*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "할오리";
                else if (LikeOperator.LikeString(ID, "1178*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "할니논";
                else if (LikeOperator.LikeString(ID, "1179*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "할즈나";
                else if (LikeOperator.LikeString(ID, "1180*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "크레짓타";
                else if (LikeOperator.LikeString(ID, "1181*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "란파";
                else if (LikeOperator.LikeString(ID, "1183*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "프츠네";
                else if (LikeOperator.LikeString(ID, "1184*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "프오리";
                else if (LikeOperator.LikeString(ID, "1185*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "카린";
                else if (LikeOperator.LikeString(ID, "1190*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "느이오";
                else if (LikeOperator.LikeString(ID, "1191*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "느우카";
                else if (LikeOperator.LikeString(ID, "1192*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "성히루";
                else if (LikeOperator.LikeString(ID, "1193*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "성리노";
                else if (LikeOperator.LikeString(ID, "1199*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "성푸딩";
                else if (LikeOperator.LikeString(ID, "1204*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "프미미";
                else if (LikeOperator.LikeString(ID, "1205*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "프소기";
                else if (LikeOperator.LikeString(ID, "1206*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "프쿄";
                else if (LikeOperator.LikeString(ID, "1207*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "뉴셰피";
                else if (LikeOperator.LikeString(ID, "1208*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "뉴루카";
                else if (LikeOperator.LikeString(ID, "1209*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "뉴리야";
                else if (LikeOperator.LikeString(ID, "1210*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "오페코";
                else if (LikeOperator.LikeString(ID, "1211*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "오캬루";
                else if (LikeOperator.LikeString(ID, "1212*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "오라비";
                else if (LikeOperator.LikeString(ID, "1213*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "스루미";
                ...
                else if (LikeOperator.LikeString(ID, "1807*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "하츠시오";
                else if (LikeOperator.LikeString(ID, "1808*1", Microsoft.VisualBasic.CompareMethod.Binary)) return "리틀리리";
        ...
        {
            int i;
            if (int.TryParse(tb_MaxUnique.Text.Replace(",", ""), out i))
            {
        ...
        private void tb_MaxItemQuqn_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            int i;
            if (int.TryParse(tb_MaxItemQuqn.Text.Replace(",", ""), out i))
            {
                tb_MaxItemQuqn.Text = i.ToString();
                int x = Convert.ToInt32(tb_MaxItemQuqn.Text);
                if (x > 6)
                    x = 6;
                maxItemQuantity = Convert.ToInt32(x);
            }
            else
            {
                tb_MaxItemQuqn.Text = Convert.ToString(maxItemQuantity);
        ...
        private void tb_MaxRank_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            int i;
            if (int.TryParse(tb_MaxRank.Text.Replace(",", ""), out i))
            {
...
+ System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString() + @"/");
        ...
        private void InitialText()
        {
            ...
            Rtb_info_maker.Document.Blocks.Add(new Paragraph(new Run("사용한 것들 : ")));
